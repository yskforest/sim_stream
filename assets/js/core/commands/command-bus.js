        ...
        execute: function execute(command) {
            ...
            if (target === "couch") {
                ...
                if (action === "getState")
                    return withLog(command, {
                        success: true,
                        state: global.CTStore && global.CTStore.getState() ? global.CTStore.getState().couch : null,
                    });
            ...
            if (target === "injector") {
                ...
                if (action === "getState")
                    return withLog(command, {
                        success: true,
                        state: global.CTStore && global.CTStore.getState() ? global.CTStore.getState().injector : null,
                    });
            ...
            if (target === "gantry") {
                ...
                if (action === "setField")
                    return withLog(
                        command,
                        global.CTStore.dispatch({ type: "set", scope: "gantry", key: params.key, value: params.value }),
                    );
                if (action === "setDetectorRows") {
                    var allowedRows =
                        global.CTProfileService && global.CTProfileService.getDetectorRowsOptions
                ...
                if (action === "getState")
                    return withLog(command, {
                        success: true,
                        state: global.CTStore && global.CTStore.getState() ? global.CTStore.getState().gantry : null,
                    });
            ...
            if (target === "simulator") {
                ...
                if (action === "getState") {
                    return withLog(command, {
                        success: true,
                        state: global.CTStore ? global.CTStore.getState() : null,
                    });
                }
